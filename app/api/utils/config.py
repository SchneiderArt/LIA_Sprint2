...
# ── Raízes ────────────────────────────────────────────────────────────────────
# app/utils/config.py → subir três níveis chega à raiz do projeto.
RAIZ_PROJETO: Path = Path(__file__).resolve().parent.parent.parent
PASTA_PROMPTS: Path = RAIZ_PROJETO / "prompts"
PASTA_SAIDAS: Path = RAIZ_PROJETO / "saidas"
